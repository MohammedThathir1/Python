...
And your clue lies where sacred knowledge expands  ''', "answer": 3000},
    ...
    [   # Questions for Bot 16
        ...
        {"question": '''What is 6 - 2?''', "answer": 4},

        {"question": '''What is 5 * 3?''', "answer": 15},
    ],
    [   # Questions for Bot 17
        {"question": '''What is 1 + 1?''', "answer": 2},
...
int main() {
    printf("%c%c%c%c%c%c%c %c%c%c%c%c%c%c %c%c%c%c%c%c%c %c%c%c%c%c%c%c %c%c%c%c%c%c%c%c %c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n",
        67, 104, 105, 97, 109, 97, 32, 
        113, 117, 101, 115, 116, 111, 32,          
        110, 117, 109, 101, 114, 111, 32,     
        49,                                   
        66, 66,                               
        48,                                   
        66, 65, 56, 70, 56,                   
...
'''
                    ...
                    end_message = "Chiama questo numero 23E63A9F2."
                else:
                    end_message = "Chiama questo numero 1D3E65952."
...
def run_bot(token, questions, bot_index):
...
def main():
    ...
    for i, token in enumerate(tokens):
        p = multiprocessing.Process(target=run_bot, args=(token, questions_list[i], i))
        p.start()
        processes.append(p)
